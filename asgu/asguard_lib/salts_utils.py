...
# Add the path to the scrapers directory
addon_dir = os.path.dirname(os.path.dirname(__file__))  # Adjust this if necessary
scrapers_dir = os.path.join(addon_dir, 'scrapers')
sys.path.append(scrapers_dir)

# Now you can import the modules from the scrapers directory
